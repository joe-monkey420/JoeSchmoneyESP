...
KeyBinds = {
    ...
    local Meshes = {
        ...
        ["rbxassetid://5196551436"] = "Old Amulet",
        ...
        ["rbxassetid://%205196551436%20"] = "Old Amulet",
    ...
    function CreateESP(Character, Class)
        ...
        pcall(function()
            ...
            elseif Character.Parent:IsA("Part") and Character.Parent:FindFirstChildWhichIsA("SpecialMesh") and Character.Parent:FindFirstChild("OrbParticle") then
                Name.Text = tostring("???")
            elseif Character.Parent.Material == Enum.Material.Slate then
                Name.Text = tostring("Idol")
            elseif Character.Parent:IsA("Part") and Character.Parent:FindFirstChildWhichIsA("SpecialMesh").MeshType == Enum.MeshType.Sphere then
                Name.Text = tostring("Opal")
            else
                Name.Text = tostring("Artifact!")
            end
        end)
